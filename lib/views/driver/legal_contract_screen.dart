      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection('3. YASAL DAYANAK', 
              'Bahtiyar Platformu, sürücülerin bireysel taşımacılık haklarını yasal zeminde korumak adına kira sözleşmesi ve hukuki danışmanlık altyapısı sunar. Trafik denetimlerinde bu belgenin ibrazı zorunludur.'),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                   ...
                   _buildRow('Durum:', 'YASAL OLARAK AKTİF'),
                ],
              ),
            ),
            ...
            const Center(
              child: Text(
                'Bu belge, Ortak Yol Hukuki Kalkan kapsamında\n7/24 Avukat Desteği ile korunmaktadır.',
                textAlign: TextAlign.center,
                style: TextStyle(fontStyle: FontStyle.italic, color: Colors.red, fontSize: 12),
              ),
            ),
          ],
        ),
